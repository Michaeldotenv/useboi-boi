...
import (
	...
	"boiboi-backend/api/admin/manage_orders"
	"boiboi-backend/api/auth"
	"boiboi-backend/api/carts"
	"boiboi-backend/api/coupons"
	"boiboi-backend/api/inventories"
	"boiboi-backend/api/notifications"
	"boiboi-backend/api/orders"
	"boiboi-backend/api/payments"
	"boiboi-backend/api/public"
	"boiboi-backend/api/users"
	"boiboi-backend/api/vendors"
