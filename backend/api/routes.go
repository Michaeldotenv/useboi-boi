...
import (
	...
	"github.com/Michaeldotenv/useboi-boi/backend/api/admin/manage_orders"
	"github.com/Michaeldotenv/useboi-boi/backend/api/auth"
	"github.com/Michaeldotenv/useboi-boi/backend/api/carts"
	"github.com/Michaeldotenv/useboi-boi/backend/api/coupons"
	"github.com/Michaeldotenv/useboi-boi/backend/api/inventories"
	"github.com/Michaeldotenv/useboi-boi/backend/api/notifications"
	"github.com/Michaeldotenv/useboi-boi/backend/api/orders"
	"github.com/Michaeldotenv/useboi-boi/backend/api/payments"
	"github.com/Michaeldotenv/useboi-boi/backend/api/public"
	"github.com/Michaeldotenv/useboi-boi/backend/api/users"
	"github.com/Michaeldotenv/useboi-boi/backend/api/vendors"
