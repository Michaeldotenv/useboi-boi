      ...
      <Wrapper>
        <Box py={4}>
          ...
          <Flex justify="space-between" align="center" mb={6} mt={4}>
            <HStack spacing={4}>
              <Box
                ...
                bg="gray.50"
              >
                <FaUserCircle color="#374151" size="20px" />
              </Box>
            ...
            <VStack spacing={4} align="stretch">
              <Flex align="center" gap={4}>
                ...
                <VStack align="start" spacing={1} flex={1}>
                  <Text fontSize={{ base: 'lg', md: 'xl' }} fontWeight="700" color="gray.900" noOfLines={1}>
                    {me.firstName} {me.lastName}
                  </Text>
                  <Text fontSize={{ base: 'sm', md: 'md' }} color="gray.600" noOfLines={1}>
                    {me.email}
                  </Text>
                  <Text fontSize={{ base: 'sm', md: 'md' }} color="gray.600" noOfLines={1}>
                    📱 {me.phoneNumber}
              ...
              {isEditing && (
                ...
                >
                  <Divider my={4} />
                  <Text fontSize={{ base: 'md', md: 'lg' }} fontWeight="600" color="gray.900" mb={4}>
              ...
              >
                <VStack spacing={3}>
                  <Box
                    ...
                    bg={`${stat.color}.50`}
                  >
                    <Icon as={stat.icon} color={`${stat.color}.500`} fontSize={{ base: '18px', md: '20px' }} />
                  </Box>
          ...
          <VStack spacing={4} align="stretch" mb={8}>
            <Text fontSize={{ base: 'lg', md: 'xl' }} fontWeight="600" color="gray.900" mb={2}>
              Account Settings
            </Text>
