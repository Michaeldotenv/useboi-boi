...
import { FiShoppingCart, FiUser, FiHeart, FiMapPin, FiZap } from "react-icons/fi"
  ...
  return (
    <>
      <Box
        ...
        minH="72px"
      >
        <Flex maxW="7xl" mx="auto" justify="space-between" align="center" gap={4} wrap="nowrap" h="full">
          {/* Logo - Always visible */}
          <motion.div
          ...
          >
            <Box cursor="pointer" onClick={() => router.push("/")} flexShrink={0} display="flex" alignItems="center">
              <Image
          ...
          <Flex flex={1} maxW="600px" mx={8} display={{ base: "none", md: "flex" }} align="center" gap={4}>
            {/* Location */}
            <HStack
              spacing={3}
              px={4}
            ...
            >
              <Box bg="brand.primary" borderRadius="full" p={1.5}>
      ...
      {/* Mobile Drawer */}
      <Drawer isOpen={isOpen} placement="right" onClose={onClose} size="full" blockScrollOnMount={false}>
        <DrawerOverlay bg="rgba(0, 0, 0, 0.4)" backdropFilter="blur(8px)" />
        <DrawerContent>
          <DrawerHeader borderBottom="1px solid" borderColor="gray.100" py={4} px={6} bg="white">
            <Flex justify="space-between" align="center">
              <Image
                ...
                objectFit="contain"
              />
              <DrawerCloseButton size="md" position="relative" top={0} right={0} _hover={{ bg: "gray.100" }} />
            </Flex>
          </DrawerHeader>

          <DrawerBody py={6} px={6} bg="gray.50" overflowY="auto">
            <VStack spacing={6} align="stretch">
              ...
              <VStack spacing={3} align="stretch" mt={6}>
                ...
                <Button
                  bgGradient="linear(135deg, purple.600, fuchsia.500)"
                  color="white"
                  size="lg"
                  fontSize="md"
                  fontWeight="600"
