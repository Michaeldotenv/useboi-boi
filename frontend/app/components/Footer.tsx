...
import { Box, Flex, VStack, HStack, Text, Link, Divider, Image, SimpleGrid, Stack } from "@chakra-ui/react"
...
export default function Footer({ variant = "default" }: FooterProps) {
      ...
      <Box bg="gray.900" color="white" py={{ base: 6, md: 8 }}>
        ...
        >
          <Image
            ...
            objectFit="contain"
          />
          <Text fontSize={{ base: "xs", sm: "sm" }} color="gray.400" textAlign={{ base: "center", md: "left" }}>
  ...
  return (
    <Box bg="black" borderTop="1px solid" borderColor="gray.800">
      {/* Download Apps Section - Mobile Optimized */}
      <Box bg="black" py={{ base: 8, xs: 10, sm: 12 }} borderTop="1px solid" borderColor="gray.800">
        <Flex
          maxW="7xl"
          mx="auto"
          px={{ base: 3, xs: 4, sm: 5, md: 6, lg: 8 }}
        ...
        >
          ...
          <Box display={{ base: "none", lg: "block" }} flexShrink={0}>
            <Image src="/media04.png" alt="Mobile app preview" height="300px" width="250px" objectFit="contain" />
          </Box>
        </Flex>
      </Box>
        ...
        <Box maxW="7xl" mx="auto" px={{ base: 3, xs: 4, sm: 5, md: 6, lg: 8 }}>
          ...
          <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={{ base: 8, md: 8, lg: 8 }} alignItems="start">
            ...
            >
              ...
              >
                Delivering convenience and quality to campus communities through efficient, sustainable, and
                technology-driven errand services.
              </Text>
              <HStack
                spacing={{ base: 3, sm: 4 }}
                pt={2}
            ...
            >
              ...
              <VStack
                ...
                maxW={{ base: "300px", md: "none" }}
              >
                <HStack spacing={3} align="start" justify={{ base: "center", md: "flex-start" }} w="full">
                  <Box color="purple.400" pt={1} flexShrink={0}>
                    <FaLocationArrow size="14px" />
                  </Box>
                  <Text color="gray.400" textAlign={{ base: "center", md: "left" }} lineHeight="1.5">
                    Campus communities nationwide
                  </Text>
                </HStack>
                <VStack spacing={2} align={{ base: "center", md: "start" }} w="full">
                  <Text color="gray.400" textAlign={{ base: "center", md: "left" }} wordBreak="break-word">
      ...
      <Box py={{ base: 4, xs: 5, sm: 6 }}>
        <Flex
          ...
          textAlign="center"
        >
          <Text color="gray.500" fontSize={{ base: "xs", xs: "sm", sm: "sm" }} order={{ base: 1, md: 1 }}>
            © Boi Technologies {currentYear}. All rights reserved.
          </Text>
